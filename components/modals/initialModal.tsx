...
/**
 * UI Modal meant to take in two inputs 
 * 
      ...
      <DialogContent className="bg-white text-black p-0">
        <DialogHeader className="px-8 py-6">
          ...
          <DialogDescription className="text-center text-zinc-500">
            Give your server a personality with a name and an image. <br />
            ...
            <div className="space-y-8">
              <div className="flex items-center justify-center text-center">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormControl  className=" focus-visible:border-0 focus:border-0">
                        <FileUpload
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription className="uppercase text-xs font-bold text-zinc-500 dark:text-secondary/70 mt-2">
                    This will be server's name.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
